...
│   └── generate_plots.py    # Visualizing tTime-Domain Signals and the Frequency Spectrum Analysis
|
├── 📂 tests/                   
...
## 📊 Digital Signal Processing Analytics Profile
Below is the real-time mathematical plot generated by our pipeline processing the downloaded NOAA satellite asset, isolating the target subcarrier frequency:

![Satellite Signal Profile](docs/assets/signal_analysis_profile.png)

## 🚀 How to Run and Test This Project
1. Clone the repository.
2. Install dependencies: `pip install -r requirements.txt`
3. Initialize the database schema: `psql -U user -d database -f database/schema.sql`
4. Execute the pipeline: `python src/db_pipeline.py --input data/raw/test_11025hz.wav`
